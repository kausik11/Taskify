...
function BottomPerformers({ isTableOpen }: { isTableOpen: boolean }) {
          ...
          Bottom Performers
			...
			{!isTableOpen && (
				<div
					...
					role="list"
					aria-label="Bottom performers list"
				>
					{renderPerformers}
				</div>
			)}
...
export default React.memo(BottomPerformers);
