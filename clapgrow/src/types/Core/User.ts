...
export interface User {
  ...
  /**	Role Profiles : Table MultiSelect - User Role Profile	*/
  role_profiles?: UserRoleProfile[];
  ...
  /**	Code Editor Type : Select	*/
  code_editor_type?: "vscode" | "vim" | "emacs";
